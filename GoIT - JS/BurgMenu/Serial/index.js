// let categoriasTop = document.querySelector('.categoriasTop');

// let apiTop =
//    'https://api.themoviedb.org/3/movie/top_rated?api_key=c2b5de19f08adc486af54dcc0c9946be&language=ru-RU&page=1';
// fetch(apiTop)
//    .then(response => response.json())
//    .then(data => {
//       for (let el of data.results) {
//          categoriasTop.innerHTML += `
...
// let apiLatest =
// 'https://api.themoviedb.org/3/movie/now_playing?api_key=c2b5de19f08adc486af54dcc0c9946be&language=ru-RU&page=1';
// fetch(apiLatest)
//    .then(response => response.json())
//    .then(data => {
//       for (let el of data.results) {
...
let serialsPopular = document.querySelector('.seialsPopular');

let apiSerialsPopular = 'https://api.themoviedb.org/3/tv/popular?api_key=c2b5de19f08adc486af54dcc0c9946be&language=ru-RU&page=1';
...
let apiseialsTopRated = 'https://api.themoviedb.org/3/tv/top_rated?api_key=c2b5de19f08adc486af54dcc0c9946be&language=ru-US&page=1';
...
let apiseialsOnTheAir = 'https://api.themoviedb.org/3/tv/on_the_air?api_key=c2b5de19f08adc486af54dcc0c9946be&language=ru-US&page=1';
fetch(apiseialsTopRated)
   .then(response => response.json())
   .then(data => {
      for (let el of data.results) {
