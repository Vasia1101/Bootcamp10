      ...
      fetch(API)
        ...
        .then(data => {
          ...
          if (data.results.length !== 0) {
            ...
            categoriasUpcoming.innerHTML = `<div class="requestNotFound" height="200px" background-color="blue" ><p>По Вашему запросу ничего не найдено!</p></div>`;
          }
