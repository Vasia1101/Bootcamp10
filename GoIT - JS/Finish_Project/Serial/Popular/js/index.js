...
let pagesLinkPopular = document.querySelectorAll('.pagesLink');
...
arrowLinkRight.addEventListener('click', getPageSerialsPopular);
window.addEventListener('load', getFilmCardsPopular(actPopular));
