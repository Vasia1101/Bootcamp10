...
function sortFilmUpName(evt) {
   evt.preventDefault();
   console.log(evt);
   let apiseialsTopRated = `https://api.themoviedb.org/3/tv/top_rated?api_key=c2b5de19f08adc486af54dcc0c9946be&language=ru-US&page=${actTopRated}`;
   ...
   fetch(apiseialsTopRated)
      ...
      .then(data => {
         ...
         let resArr = arr1.sort((a, b) => (a.name).localeCompare(b.name));
         console.log(resArr)
...
function sortFilmDownName(evt) {
   ...
   fetch(apiseialsTopRated)
      ...
      .then(data => {
         ...
         let arr1 = data.results;
         let resArr = arr1.sort((a, b) => (b.name).localeCompare(a.name));
         console.log(resArr)
         for (let el of resArr) {
...
function sortFilmUpDate(evt) {
   ...
   fetch(apiseialsTopRated)
      ...
      .then(data => {
         ...
         let arr1 = data.results;
         let resArr = arr1.sort((a, b) => (a.first_air_date).localeCompare(b.first_air_date));
         console.log(resArr)
         for (let el of resArr) {
...
function sortFilmDownDate(evt) {
   ...
   fetch(apiseialsTopRated)
      ...
      .then(data => {
         ...
         let arr1 = data.results;
         let resArr = arr1.sort((a, b) => (b.first_air_date).localeCompare(a.first_air_date));
         console.log(resArr)
         for (let el of resArr) {
