...
function startEmulator(instance) {
            ...
            utils.logBullet(`To select a different port for the emulator, update your "firebase.json":
    {
      ...
      "emulators": {
        ...
        yield waitForPortClosed(info.port);
    });
}
...
function startAll(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (targets.indexOf(types_1.Emulators.FUNCTIONS) > -1) {
        ...
        if (targets.indexOf(types_1.Emulators.FIRESTORE) > -1) {
        ...
        if (targets.indexOf(types_1.Emulators.DATABASE) > -1) {
        ...
        if (targets.indexOf(types_1.Emulators.HOSTING) > -1) {
